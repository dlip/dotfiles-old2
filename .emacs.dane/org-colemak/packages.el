...
(setq org-colemak-excluded-packages
  '(
    ;; seems to be problematic, to investigate
    ox-gfm
    ))

(defun org-colemak/init-evil-org ()
...
(defun org-colemak/init-org-bullets ()
  (use-package org-bullets
    :defer t
    :init (add-hook 'org-mode-hook 'org-bullets-mode)))

(defun org-colemak/init-org-pomodoro ()
...
(defun org-colemak/init-org-present ()
...
(defun org-colemak/init-org-repo-todo ()
...
(defun org-colemak/init-ox-gfm ()
  (use-package ox-gfm
    :defer t))

(defun org-colemak/init-htmlize ()
 (use-package htmlize
    :defer t))
